...
module.exports = {
    inGameCommandHandler: async function (rustplus, client, message) {
        ...
        else if (commandLowerCase.startsWith(`${prefix}${client.intlGet('en', 'commandSyntaxSwitch')}`) ||
            commandLowerCase.startsWith(`${prefix}${client.intlGet(guildId, 'commandSyntaxSwitch')}`)) {
            rustplus.sendInGameMessage(await rustplus.getCommandSwitch(command));
        }
        ...
        if (commandLowerCase.startsWith(`${prefix}${client.intlGet('en', 'commandSyntaxCalc')}`) ||
            commandLowerCase.startsWith(`${prefix}${client.intlGet(guildId, 'commandSyntaxCalc')}`)) {
            rustplus.sendInGameMessage(rustplus.getCommandCalcResult(command));
        }
        else {
